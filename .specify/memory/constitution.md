...
* `<NNN>-<short-kebab-description>` for Spec Kit features, generated by
  `/speckit-specify` — for example `001-chatgpt-import`. These MUST NOT be
  renamed: the name mirrors the feature directory under `specs/`, and the
  workflow scripts resolve one from the other.
